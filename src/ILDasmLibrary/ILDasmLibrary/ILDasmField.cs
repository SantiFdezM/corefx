    ...
    public struct ILDasmField
    {
        ...
        public string Type
        {
            get
            {
                if(_type == null)
                {
                    _type = SignatureDecoder.DecodeFieldSignature(_fieldDefinition.Signature, new ILDasmTypeProvider(_mdReader)).ToString();
                }
                return _type;
            }
        }
        ...
        private string GetMarshalAttributes()
        {
            ...
            sb.Append("marshal(");
            var type = SignatureDecoder.DecodeType(_fieldDefinition.GetMarshallingDescriptor(), new ILDasmTypeProvider(_mdReader));
            sb.Append(type);
            sb.Append(") ");
            return sb.ToString();
        }
